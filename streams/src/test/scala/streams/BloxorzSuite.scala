...
class BloxorzSuite extends FunSuite {
  ...
  test("terrain function level 1 negative values") {
    new Level1 {
  ...
  test("newNeighboursOnly level 1") {
  ...
  test("optimal solution for level 1") {
    new Level1 {
      println("solution for lv1=" + solve(solution))
