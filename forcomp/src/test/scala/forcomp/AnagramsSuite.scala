...
class AnagramsSuite extends FunSuite {
  ...
  test("sentenceOccurrences: abcd e ed") {
    assert(sentenceOccurrences(List("abcd", "e", "ed")) === List(('a', 1), ('b', 1), ('c', 1), ('d', 2), ('e', 2)))
  }
  ...
  test("subtract: larrd - ar") {
    val larrd = List(('a', 1), ('d', 1), ('l', 1), ('r', 2))
    val ar = List(('a', 1), ('r', 1))
    val lrd = List(('d', 1), ('l', 1), ('r', 1))
    assert(subtract(larrd, ar) === lrd)
  }
